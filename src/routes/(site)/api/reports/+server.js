...
export async function POST({ request }) {
  ...
  const { type, message, reporter_name, reporter_email, reporter_id,
          reported_user_id, reported_username, room_id, subject, metadata } = body;
  ...
  sendReportNotification({ type, message, reporter_name, reporter_email,
    reported_username, room_id, subject, metadata }).catch(() => {});
